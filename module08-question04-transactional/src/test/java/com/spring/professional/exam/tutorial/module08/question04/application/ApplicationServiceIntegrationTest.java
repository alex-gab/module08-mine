...
public class ApplicationServiceIntegrationTest {
    ...
    @BeforeEach
    private void before(TestInfo testInfo) {
        System.out.println("BEFORE TEST: " + testInfo.getDisplayName());
        List<Guest> guests = applicationService.listGuests();
        Set<Room> rooms = applicationService.listRooms();
        System.out.println("    Guests are: " + guests);
        System.out.println("    Rooms are: " + rooms);
    }

    @AfterEach
    private void after(TestInfo testInfo) {
